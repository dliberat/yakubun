(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["yakubun"] = factory();
	else
		root["yakubun"] = factory();
...
/* harmony default export */ __webpack_exports__["a"] = (CheckResult);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return regexComparer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return regexReturnAllMatches; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return addMinutesToSimpleENTimes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return regexReplaceAllFromArray; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return replaceDoubleByteNums; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return compareArrays; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return metalogger; });
function metalogger() {
...
moment.tz.load(__webpack_require__(143));
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return verifyOptions; });
/* unused harmony export initialJPFilter */
/* unused harmony export cleanGetRichCommaDateLists */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return convertToTwoDigitDates; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return cleanStringsBeforeDateCheck; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utilities_general__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__convertToISOTime__ = __webpack_require__(139);
...
function initialJPFilter(string) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0__utilities_general__["e" /* regexReplaceAllFromArray */](arr, string, 'gi');
}
...
function cleanGetRichCommaDateLists(string) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0__utilities_general__["e" /* regexReplaceAllFromArray */](formatChanges, string, 'gi');
}
...
function cleanStringsBeforeDateCheck(src, tgt, checkOptions) {
  ...
  source = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["g" /* replaceDoubleByteNums */](source);
  ...
  source = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["e" /* regexReplaceAllFromArray */](checkOptions.dateFormats[checkOptions.sourceLang], source, 'gi');

  // //////////////////// TARGET TEXT CLEANUP ////////////////////////////////////
  // change all 11am times to 11:00am
  target = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["a" /* addMinutesToSimpleENTimes */](target);
  ...
  target = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["e" /* regexReplaceAllFromArray */](checkOptions.dateFormats[checkOptions.targetLang], target, 'gi');

  // convert any times that were caught to 24 hour format and remove am/pm
  target = Object(__WEBPACK_IMPORTED_MODULE_1__convertToISOTime__["a" /* default */])(target);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_moment_timezone__ = __webpack_require__(3);
...
function momentDateSort(a, b) {
  ...
  if (!__WEBPACK_IMPORTED_MODULE_0_moment_timezone___default.a.isMoment(a) || !__WEBPACK_IMPORTED_MODULE_0_moment_timezone___default.a.isMoment(b)) {
    return 0;
  }
...
function convertToMomentArr(comparison, sourceTz, targetTz) {
  ...
  const sourceConverter = function sourceConverter(e) {
    ...
    if (sourceTz) {
      return __WEBPACK_IMPORTED_MODULE_0_moment_timezone___default.a.tz(element, sourceTz);
    }
    return __WEBPACK_IMPORTED_MODULE_0_moment_timezone___default()(element);
  };
  const targetConverter = function targetConverter(e) {
    const element = e.slice(1, e.length - 1);
    if (targetTz) {
      return __WEBPACK_IMPORTED_MODULE_0_moment_timezone___default.a.tz(element, targetTz);
    }
    return __WEBPACK_IMPORTED_MODULE_0_moment_timezone___default()(element);
  };
...
/* harmony default export */ __webpack_exports__["a"] = (convertToMomentArr);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_moment_timezone__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_moment_timezone___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_moment_timezone__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utilities_general__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utilities_CheckResult__ = __webpack_require__(1);
...
function formatForOutput(arr, oAccumulator, sourceTZ, targetTZ) {
  ...
  for (let j = 0; j < 2; j += 1) {
    for (let i = 0; i < arr[j].length; i += 1) {
      if (__WEBPACK_IMPORTED_MODULE_0_moment_timezone___default.a.isMoment(arr[j][i])) {
  ...
  if (arr.length > 2) {
    ...
    if (slashParsedInTarget !== '' || slashParsedInSource !== '') {
      __WEBPACK_IMPORTED_MODULE_1__utilities_general__["c" /* metalogger */](`Found & parsed slash dates: ${slashParsedInTarget} ${slashParsedInSource} at segment ${Number(oAccumulator.currentSegment) + 1}`);
    }
  }
  ...
  const checkResult = new __WEBPACK_IMPORTED_MODULE_2__utilities_CheckResult__["a" /* default */]('dates');
...
/* harmony default export */ __webpack_exports__["a"] = (formatForOutput);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifyOptions__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__getTests__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__preprocess__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utilities_general__ = __webpack_require__(2);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "regexComparer", function() { return __WEBPACK_IMPORTED_MODULE_3__utilities_general__["d"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "regexReplaceAllFromArray", function() { return __WEBPACK_IMPORTED_MODULE_3__utilities_general__["e"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "regexReturnAllMatches", function() { return __WEBPACK_IMPORTED_MODULE_3__utilities_general__["f"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "compareArrays", function() { return __WEBPACK_IMPORTED_MODULE_3__utilities_general__["b"]; });
...
function startScan(bilingualDoc, checkOptions, callback) {
  let oAccumulator = {
    currentSegment: 0,
    tests: Object(__WEBPACK_IMPORTED_MODULE_1__getTests__["a" /* default */])(checkOptions),
  };
...
function scan(bilingualDoc, checkOptions, callback) {
  ...
  const cleanCheckOptions = Object(__WEBPACK_IMPORTED_MODULE_0__verifyOptions__["a" /* default */])(checkOptions);
  // run basic character conversions
  const cleanBilingualDoc = Object(__WEBPACK_IMPORTED_MODULE_2__preprocess__["a" /* default */])(bilingualDoc);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utilities_general__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dateformats__ = __webpack_require__(128);
...
function vBannedWords(list) {
  ...
  if (typeof wordList !== 'object' || Array.isArray(wordList) || wordList === null) {
    Object(__WEBPACK_IMPORTED_MODULE_0__utilities_general__["c" /* metalogger */])('No valid banned words list detected. Reverting to blank list.');
    wordList = {};
  }
...
function vDateFormats(dateFormats, sourceLang, targetLang) {
  ...
  if (typeof dateFormats !== 'object' || Array.isArray(dateFormats) || dateFormats === null) {
    Object(__WEBPACK_IMPORTED_MODULE_0__utilities_general__["c" /* metalogger */])('No valid date formats detected. Reverting to default.');
    return __WEBPACK_IMPORTED_MODULE_1__dateformats__["a" /* default */];
  }
  ...
  if (!dateFormats[sourceLang]) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__utilities_general__["c" /* metalogger */])(`ERROR: ${sourceLang} date format object must contain an array.`);
    dateFormats[sourceLang] = {};
  }
  ...
  if (!dateFormats[targetLang]) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__utilities_general__["c" /* metalogger */])(`ERROR: ${targetLang} date format object must contain an array.`);
    dateFormats[targetLang] = {};
  }
...
function vLang(lang, defaultValue) {
  ...
  if (typeof lang === 'undefined') {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__utilities_general__["c" /* metalogger */])('Invalid language code. Source and target languages must be in ISO 639-1 format. Reverting to default.');
    return defaultValue;
  }
  return lang;
}
...
function verify(options) {
  ...
  if (typeof options !== 'object') {
    Object(__WEBPACK_IMPORTED_MODULE_0__utilities_general__["c" /* metalogger */])('Invalid checkOptions. Using default options instead.');
    const defaultOptions = {
      sourceLang: 'ja',
      targetLang: 'en',
      dateFormats: __WEBPACK_IMPORTED_MODULE_1__dateformats__["a" /* default */],
      bannedWordsList: {},
      customTests: [],
    };
...
/* harmony default export */ __webpack_exports__["a"] = (dateFormats);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__checks_checks_language__ = __webpack_require__(130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__checks_doublespaces__ = __webpack_require__(131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__checks_repeatedwords__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__checks_oxfordcomma__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__checks_quote_punctuation__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__checks_bannedWords__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__checks_ordinalNumbers__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__checks_dates_comparedates__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__checks_dates_comparedates_tz__ = __webpack_require__(144);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__checks_numbers_numbers__ = __webpack_require__(145);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__checks_time_time__ = __webpack_require__(148);
...
const standardTests = [
  ['bannedWords', __WEBPACK_IMPORTED_MODULE_5__checks_bannedWords__["a" /* default */]],
  ['doubleSpaces', __WEBPACK_IMPORTED_MODULE_1__checks_doublespaces__["a" /* default */]],
  ['zenkakuCharacters', __WEBPACK_IMPORTED_MODULE_0__checks_checks_language__["b" /* findJPCharacters */]],
  ['quote-punct', __WEBPACK_IMPORTED_MODULE_4__checks_quote_punctuation__["a" /* default */]],
  ['repeatedWords', __WEBPACK_IMPORTED_MODULE_2__checks_repeatedwords__["a" /* default */]],
  ['ordinalNumbers', __WEBPACK_IMPORTED_MODULE_6__checks_ordinalNumbers__["a" /* default */]],
  ['bulletSpaces', __WEBPACK_IMPORTED_MODULE_0__checks_checks_language__["a" /* findBulletsWithNoSpaces */]],
  ['oxfordCommas', __WEBPACK_IMPORTED_MODULE_3__checks_oxfordcomma__["a" /* default */]],
  ['numberedBullets', __WEBPACK_IMPORTED_MODULE_0__checks_checks_language__["c" /* trackNumberedBullets */]],
  ['tzDates', __WEBPACK_IMPORTED_MODULE_8__checks_dates_comparedates_tz__["a" /* default */]],
  ['dates', __WEBPACK_IMPORTED_MODULE_7__checks_dates_comparedates__["a" /* default */]],
  ['times', __WEBPACK_IMPORTED_MODULE_10__checks_time_time__["a" /* default */]],
  ['numbers', __WEBPACK_IMPORTED_MODULE_9__checks_numbers_numbers__["a" /* default */]],
];
...
/* harmony default export */ __webpack_exports__["a"] = (getTests);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return findJPCharacters; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return findBulletsWithNoSpaces; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return trackNumberedBullets; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utilities_general__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utilities_CheckResult__ = __webpack_require__(1);
...
function findJPCharacters(source, target, checkOptions, oAccumulator) {
  ...
  const checkResult = new __WEBPACK_IMPORTED_MODULE_1__utilities_CheckResult__["a" /* default */]('jp-characters');
...
function findBulletsWithNoSpaces(source, target, checkOptions, oAccumulator) {
  ...
  const checkResult = new __WEBPACK_IMPORTED_MODULE_1__utilities_CheckResult__["a" /* default */]('bullet-point-spaces');
  if (test) {
    checkResult.hasError = true;
...
function trackNumberedBullets(source, target, checkOptions, oAccumulator) {
  ...
  const matchArr = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["f" /* regexReturnAllMatches */](target, re);
  ...
  for (let i = 0; i < matchArr.length; i += 1) {
    ...
    if (matchArr[i][0].indexOf(')') > -1) {
      ...
      __WEBPACK_IMPORTED_MODULE_0__utilities_general__["c" /* metalogger */](`Found a numbered bullet point at segment ${Number(oAccumulator.currentSegment) + 1}. [${num})]`);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utilities_CheckResult__ = __webpack_require__(1);


function generateResult(test, acc) {
  const checkResult = new __WEBPACK_IMPORTED_MODULE_0__utilities_CheckResult__["a" /* default */]('double-spaces');
  if (test) {
    checkResult.hasError = true;
...
/* harmony default export */ __webpack_exports__["a"] = (findDoubleSpaces);
...
function formatOutput(stringArr, oAccumulator) {
  const checkResult = new __WEBPACK_IMPORTED_MODULE_0__utilities_CheckResult__["a" /* default */]('repeatedWords', false);
...
/* harmony default export */ __webpack_exports__["a"] = (findRepeatedWords);
...
function formatOutput(test) {
  const checkResult = new __WEBPACK_IMPORTED_MODULE_0__utilities_CheckResult__["a" /* default */]('oxford-comma');
  if (test) {
    checkResult.hasError = true;
...
/* harmony default export */ __webpack_exports__["a"] = (detectOxfordCommas);
...
function generateResult(test) {
  const checkResult = new __WEBPACK_IMPORTED_MODULE_0__utilities_CheckResult__["a" /* default */]('quote-punctuation');
...
/* harmony default export */ __webpack_exports__["a"] = (quotePunctuation);
...
function outputString(outputArray) {
  const checkResult = new __WEBPACK_IMPORTED_MODULE_1__utilities_CheckResult__["a" /* default */]('banned-words');
...
function scanForBannedWords(str, wordsArr, caseSensitive = false, accumulatorArr = []) {
  ...
  wordsArr.forEach((element) => {
    ...
    foundArr = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["f" /* regexReturnAllMatches */](str, re, foundArr);
  });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ordinal_indicator__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ordinal_indicator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_ordinal_indicator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utilities_general__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utilities_CheckResult__ = __webpack_require__(1);
/*
...
function returnError(arr) {
  const checkResult = new __WEBPACK_IMPORTED_MODULE_2__utilities_CheckResult__["a" /* default */]('ordinal-numbers');
  checkResult.hasError = true;
...
function hasBadSuffix(arr) {
  ...
  const correctSuffix = __WEBPACK_IMPORTED_MODULE_0_ordinal_indicator___default()(arr[1]);
...
function runRegex(target) {
  ...
  const arr = __WEBPACK_IMPORTED_MODULE_1__utilities_general__["f" /* regexReturnAllMatches */](target, re);
  /* each arr contains
...
function ordinalNumbers(source, target, checkOptions = {}, oAccumulator) {
  ...
  if (checkOptions.targetLang !== 'en') {
    __WEBPACK_IMPORTED_MODULE_1__utilities_general__["c" /* metalogger */]('Ordinal number checks are only supported for English.');
    return returnNull();
  }
...
/* harmony default export */ __webpack_exports__["a"] = (ordinalNumbers);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utilities_general__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dates_common__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__convertToMomentArr__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__formatForOutput__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utilities_CheckResult__ = __webpack_require__(1);
...
function compareDates(source, target, checkOptions, accumulator) {
  ...
  if (!__WEBPACK_IMPORTED_MODULE_1__dates_common__["c" /* verifyOptions */](checkOptions)) {
    oAccumulator.timeCheck_clean_source = source;
    oAccumulator.timeCheck_clean_target = target;
    __WEBPACK_IMPORTED_MODULE_0__utilities_general__["c" /* metalogger */]('Invalid checkOptions. Could not compare dates');
    return [null, oAccumulator];
  }

  // source goes in [0], target goes in [1]
  const [cleanSource, cleanTarget] = __WEBPACK_IMPORTED_MODULE_1__dates_common__["a" /* cleanStringsBeforeDateCheck */](source, target, checkOptions);
  ...
  let comparison = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["d" /* regexComparer */](cleanSource, cleanTarget, datesRegExp, datesRegExp, false);
  let compare = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["b" /* compareArrays */](comparison[0], comparison[1]);

  // return if the comparison matches exactly, since no further checking is necessary
  if (compare) {
    const res = new __WEBPACK_IMPORTED_MODULE_4__utilities_CheckResult__["a" /* default */]('dates');
    res.hasError = false;
  ...
  const potentialSlashDates = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["d" /* regexComparer */](cleanSource, cleanTarget, datesRegExp, datesRegExp, false);

  // Turn all dates and times into two-digits so as to be ISO compliant
  comparison = __WEBPACK_IMPORTED_MODULE_1__dates_common__["b" /* convertToTwoDigitDates */](comparison);

  // convert to sorted moment array
  const momentArr = Object(__WEBPACK_IMPORTED_MODULE_2__convertToMomentArr__["a" /* default */])(comparison);
  compare = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["b" /* compareArrays */](momentArr[0], momentArr[1]);
  ...
  if (!compare) {
    ...
    retval = Object(__WEBPACK_IMPORTED_MODULE_3__formatForOutput__["a" /* default */])(res, oAccumulator, null, null);
  }
...
/* harmony default export */ __webpack_exports__["a"] = (compareDates);
...
/* harmony default export */ __webpack_exports__["a"] = (convertToTwentyFourHourClock);
...
function compareDatesTz(source, target, checkOptions, oAccumulator) {
  if (!__WEBPACK_IMPORTED_MODULE_1__dates_common__["c" /* verifyOptions */](checkOptions)) {
    ...
    oAccumulator.timeCheck_clean_target = target;
    __WEBPACK_IMPORTED_MODULE_0__utilities_general__["c" /* metalogger */]('Invalid checkOptions. Could not compare dates');
    const res = new __WEBPACK_IMPORTED_MODULE_4__utilities_CheckResult__["a" /* default */]('dates-tz', false);
    return [res, oAccumulator];
  }
  ...
  // convert to sorted moment array
  const momentArr = Object(__WEBPACK_IMPORTED_MODULE_2__convertToMomentArr__["a" /* default */])(comparison, sourceTZ, targetTZ);
  ...
  retval = Object(__WEBPACK_IMPORTED_MODULE_3__formatForOutput__["a" /* default */])(momentArr, oAccumulator, sourceTZ, targetTZ);
...
/* harmony default export */ __webpack_exports__["a"] = (compareDatesTz);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utilities_general__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utilities_CheckResult__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__numbers_utility__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__num_words__ = __webpack_require__(147);
...
function commonSubs(string, lang) {
  ...
  if (__WEBPACK_IMPORTED_MODULE_3__num_words__["a" /* default */][language]) {
    return __WEBPACK_IMPORTED_MODULE_0__utilities_general__["e" /* regexReplaceAllFromArray */](__WEBPACK_IMPORTED_MODULE_3__num_words__["a" /* default */][language], string, 'gi');
  }
  return string;
}

function compareAndFormat(comparison, oAccumulator) {
  let checkResult = new __WEBPACK_IMPORTED_MODULE_1__utilities_CheckResult__["a" /* default */]('numbers');
  let [src, tgt] = comparison;
  const compare = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["b" /* compareArrays */](src, tgt);
...
function oncePerAdjustments(comparison, target, oAccumulator) {
  ...
  const s = comparison[0].reduce(__WEBPACK_IMPORTED_MODULE_2__numbers_utility__["b" /* oncePerAdjustReduce */], 0);
  // count 1s in target array
  let t = comparison[1].reduce(__WEBPACK_IMPORTED_MODULE_2__numbers_utility__["b" /* oncePerAdjustReduce */], 0);
...
function extract(source, target, oAccumulator) {
  ...
  const comparison = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["d" /* regexComparer */](source, target, re, re);
...
function customSubs(source, target, checkOptions, oAccumulator) {
  ...
  if (checkOptions.numIgnoreSource) src = Object(__WEBPACK_IMPORTED_MODULE_2__numbers_utility__["d" /* subber */])(src, checkOptions.numIgnoreSource);
  if (checkOptions.numIgnoreTarget) tgt = Object(__WEBPACK_IMPORTED_MODULE_2__numbers_utility__["d" /* subber */])(tgt, checkOptions.numIgnoreTarget);
...
function clean(source, target, checkOptions, oAccumulator) {
  ...
  let src = Object(__WEBPACK_IMPORTED_MODULE_2__numbers_utility__["c" /* removeDelimiters */])(source, checkOptions.sourceLang);
  let tgt = Object(__WEBPACK_IMPORTED_MODULE_2__numbers_utility__["c" /* removeDelimiters */])(target, checkOptions.targetLang);
  ...
  if (checkOptions.numericalLetters) tgt = Object(__WEBPACK_IMPORTED_MODULE_2__numbers_utility__["a" /* letterSubs */])(tgt);
...
function replaceNumbers(source, target, checkOptions, oAccumulator) {
  const src = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["g" /* replaceDoubleByteNums */](source);
  const tgt = __WEBPACK_IMPORTED_MODULE_0__utilities_general__["g" /* replaceDoubleByteNums */](target);
...
/* harmony default export */ __webpack_exports__["a"] = (compareNumbers);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return letterSubs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return removeDelimiters; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return subber; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return oncePerAdjustReduce; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utilities_general__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utilities_CheckResult__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utilities_convertTimesToISO__ = __webpack_require__(149);
...
function momentSortByTime(a, b) {
  ...
  if (!__WEBPACK_IMPORTED_MODULE_0_moment_timezone___default.a.isMoment(a) || !__WEBPACK_IMPORTED_MODULE_0_moment_timezone___default.a.isMoment(b)) { return 0; }
...
function parseTimeStringsIntoMomentArr(stringsArr) {
  ...
  stringsArr.forEach((e) => {
    const x = Object(__WEBPACK_IMPORTED_MODULE_3__utilities_convertTimesToISO__["a" /* default */])(e); // moment requires ISO 8601 strings
    const mom = __WEBPACK_IMPORTED_MODULE_0_moment_timezone___default()(x);
    // ensure that it got converted correctly
    if (mom.isValid()) {
      outArr.push(mom);
    } else {
      __WEBPACK_IMPORTED_MODULE_1__utilities_general__["c" /* metalogger */]('Invalid moment.');
    }
  });
...
function hikaku(sourceMoments, targetMoments) {
  ...
  const checkResult = new __WEBPACK_IMPORTED_MODULE_2__utilities_CheckResult__["a" /* default */]('time');
...
function extract() {
  ...
  const comparison = __WEBPACK_IMPORTED_MODULE_1__utilities_general__["d" /* regexComparer */](source, target, sourceRegEx, targetRegEx, false);
...
function clean() {
  ...
  source = __WEBPACK_IMPORTED_MODULE_1__utilities_general__["g" /* replaceDoubleByteNums */](source);
...
/* EXPORTS */
/* harmony default export */ __webpack_exports__["a"] = (compareTimes);
...
/* harmony default export */ __webpack_exports__["a"] = (convertTimesToISO);
...
/* harmony default export */ __webpack_exports__["a"] = (preprocess);
